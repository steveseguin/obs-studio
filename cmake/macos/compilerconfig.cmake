...
if(CMAKE_OSX_SYSROOT)
  string(REGEX MATCH ".+/MacOSX\\.platform/Developer/SDKs/MacOSX([0-9]+\\.[0-9]+)\\.sdk$" _matched "${CMAKE_OSX_SYSROOT}")
  if(_matched)
    set(_obs_macos_current_sdk "${CMAKE_MATCH_1}")
  else()
    set(_obs_macos_current_sdk "15.2")  # Default to current version
  endif()
else()
  set(_obs_macos_current_sdk "15.2")  # Default to current version
endif()
